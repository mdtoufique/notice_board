...
public class newp extends AppCompatActivity {
    ...
    public void goToSignIn(View view) {
        Intent intent = new Intent(newp.this,MainActivity.class);
    ...
    public void check(View view) {
        ...
        mAuth.createUserWithEmailAndPassword(mail, pas)
                .addOnCompleteListener(newp.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(newp.this, "Sign Up Complete", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(newp.this, MainActivity.class);
                            startActivity(intent);
                        }
                    }
                }) .addOnFailureListener(newp.this , new OnFailureListener() {

                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(newp.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
